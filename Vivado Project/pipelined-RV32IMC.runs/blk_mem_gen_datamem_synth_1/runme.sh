...
HD_PWD='C:/Users/MJ/Documents/Vivado/pipelined-RV32IMC/pipelined-RV32IMC.runs/blk_mem_gen_datamem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_datamem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_datamem.tcl

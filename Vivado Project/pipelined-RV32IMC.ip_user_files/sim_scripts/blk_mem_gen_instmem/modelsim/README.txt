...
#
# Generated by export_simulation on Sun Jan 26 13:56:25 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_instmem.sh' script.

./blk_mem_gen_instmem.sh -reset_run
...
./blk_mem_gen_instmem.sh -noclean_files

For more information on the script, please type './blk_mem_gen_instmem.sh -help'.

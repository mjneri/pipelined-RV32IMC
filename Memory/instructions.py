...
instruction_dict= {
    ...
    'C.JAL':    {'args':1,  'syntax':'l',       'i_width':12,   'format':'CJ',  'opcode':1,     'funct3':1,                 'expansion_method':'insert',		'expansion':'jal x1, label'},
    'C.LI':     {'args':2,  'syntax':'r-i',     'i_width':6,    'format':'CI',  'opcode':1,     'funct3':2,                 'expansion_method':'replace',		'expansion':'addi, rd, x0, imm',        'equivalent':'addi'},
    'C.ADDI16SP':{'args':1, 'syntax':'i',       'i_width':10,   'format':'C16', 'opcode':1,     'funct3':3,                 'expansion_method':'replace',		'expansion':'addi x2, x2, nzimm[9:4]',  'equivalent':'addi'},
    ...
    'C.J':      {'args':1,  'syntax':'l',       'i_width':12,   'format':'CJ',  'opcode':1,     'funct3':5,                 'expansion_method':'replace',		'expansion':'jal, x0, label',           'equivalent':'jal'},
    'C.BEQZ':   {'args':2,  'syntax':'r-l',	    'i_width':9,    'format':'CB',  'opcode':1,     'funct3':6,                 'expansion_method':'replace',		'expansion':'beq rs1_, x0, label',      'equivalent':'beq'},
    'C.BNEZ':   {'args':2,  'syntax':'r-l',	    'i_width':9,    'format':'CB',  'opcode':1,     'funct3':7,                 'expansion_method':'replace',		'expansion':'bne rs1_, x0, label',      'equivalent':'bne'},
    ...
    'C.JR':     {'args':1,  'syntax':'r',                       'format':'CR',  'opcode':2,     'funct4':8,                 'expansion_method':'replace',		'expansion':'jalr x0, rs1, 0',          'equivalent':'jalr'},
    'C.MV':     {'args':2,  'syntax':'r-r',                     'format':'CR',  'opcode':2,     'funct4':8,                 'expansion_method':'replace',		'expansion':'add rd, x0, rs2',          'equivalent':'add'},
    'C.EBREAK': {'args':0,  'syntax':'none',                    'format':'N',   'opcode':36866,                             'expansion_method':'none',			'expansion':'ebreak'},
    'C.JALR':   {'args':1,  'syntax':'r',	                    'format':'CR',  'opcode':2,     'funct4':9,                 'expansion_method':'replace',		'expansion':'jalr x1, rs1, 0',          'equivalent':'jalr'},

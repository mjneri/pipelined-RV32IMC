...
sw x8, 16(x12)	#from c.sw x8, 4(x12)

addi x14, x0, 36
lw x8, 0(x14)	#from c.lw x8, 0(x14)
sw x8, 112(x12)	#from c.sw x8, 28(x12)

# c.lwsp
lw x8, 16(x2)	#from c.lwsp x8, 4
sw x8, 192(x2)	#from c.swsp x8, 48

addi x2, x0, 8  # REMINDER: X2 IS STACK POINTER
lw x8, 0(x2)	#from c.lwsp x8, 0
slli x27, x2, 2
sw x8, 208(x2)	#from c.swsp x8, 52

addi x13, x0, 0
# c.lui
lui x9, 0xe	#from c.lui x9, 0xe
sw x9, 80(x13)	#from c.sw x9, 20(x13)

lui x10, 0x1a	#from c.lui x10, 0x1a
sw x10, 96(x13)	#from c.sw x10, 24(x13)

# c.li
addi x11, x0, 0xa	#from c.li x11, 0xa
sw x11, 112(x13)	#from c.sw x11, 28(x13)

slt x14, x11, x10

addi x12, x0, 0x1d	#from c.li x12, 0x1d
sw x12, 120(x13)	#from c.sw x12, 30(x13)
...
sw x4, 288(x31)
# + -
add x4, x4, x6	#from c.add x4, x6
sw x4, 292(x31)
# - +
add x7, x4, x3
sw x7, 296(x31)
# - -
add x7, x7, x4	#from c.add x7, x4
sw x8, 300(x31)
# x 0
add x8, x8, x31	#from c.add x8, x31
sw x8, 304(x31)
# 0 x
add x3, x31, x3
sw x3, 308(x31)
...
add x4, x0, x0
sw x4, 312(x31)
add x4, x4, x31	#from c.add x4, x31
sw x4, 312(x31)
...
sw x10, 320(x31)
# - +
addi x10, x10, 17	#from c.addi x10, 17
addi x10, x10, 21	#from c.addi x10, 21
sw x10, 324(x31)
# - -
addi x11, x10, -97
...
# c.addi16sp
# +
addi x2, x2, 64	#from c.addi16sp 4
sw x2, 336(x31)
# -
addi x2, x2, -64	#from c.addi16sp -4
sw x2, 340(x31)
...
sw x5, 348(x31)
# + -
sub x9, x9, x11	#from c.sub x9, x11
sw x9, 352(x31)
# - +
lw x26, 16(x31)
sub x6, x5, x26
sw x6, 356(x31)
# - -
sub x10, x10, x9	#from c.sub x10, x9
sw x10, 360(x31)
# x 0
sub x6, x6, x31
sw x6, 364(x31)
...
addi x22, x22, -4	#from c.addi x22, -4
...
lw x13, 4(x31)
sll x12, x10, x13
addi x14, x14, 2	#from c.addi x14, 2
sw x12, 560(x31)
...
lw x10, 44(x31)
srai x10, x10, 10	#from c.srai x10, 10
sw x10, 616(x31)
...
addi x11, x0, 307
and x11, x11, x10	#from c.and x11, x10
sw x11, 740(x31)
...
or x12, x12, x8	#from c.or x12, x8
sw x12, 748(x31)
...
xor x13, x13, x15	#from c.xor x13, x15
sw x13, 756(x31)
...
# MV
add x19, x0, x20	#from c.mv x19, x20
add x16, x0, x19	#from c.mv x16, x19
sw x16, 776(x31)
...
here1:
addi x11, x11, -1	#from c.addi x11, -1
bne x11, x0, here1	#from c.bnez x11, here1
jal x1, jump2	#from c.jal jump2
sw x11, 824(x29)
...
# c.j
addi x12, x12, 17	#from c.addi x12, 17
here2:
addi x12, x12, -1
bne x12, x0, here2	#from c.bnez x12, here2
jal x0, jump3	#from c.j jump3
sw x12, 828(x29)

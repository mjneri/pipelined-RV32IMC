...
instruction_dict= {
    ...
    'C.ADDI4SPN':{'args':2, 'syntax':'r-i',     'i_width':10,   'format':'CIW', 'opcode':0,     'funct3':0,                 'expansion_method':'x2_times_4',    'expansion':'addi rd_, x2, nzimm[9:2]', 'equivalent':'addi'},
    #'C.FLD':    {'args':3,  'syntax':'r-i_r',   'i_width':8,    'format':'CLS', 'opcode':0,     'funct3':1,                 'expansion_method':'none',			 'expansion':'none'},
    'C.LW':     {'args':3,  'syntax':'r-i_r',   'i_width':7,    'format':'CLS', 'opcode':0,     'funct3':2,                 'expansion_method':'times_4',			'expansion':'lw rd_, offset[6:2](rs1_)', 'equivalent':'lw'},
    ...
    'C.SW':     {'args':3,  'syntax':'r-i_r',   'i_width':7,    'format':'CLS', 'opcode':0,     'funct3':6,                 'expansion_method':'times_4',			'expansion':'sw rs2_, offset[6:2](rs1_)', 'equivalent':'sw'},
    ...
    'C.ADDI16SP':{'args':1, 'syntax':'i',       'i_width':10,   'format':'C16', 'opcode':1,     'funct3':3,                 'expansion_method':'times_16',		'expansion':'addi x2, x2, nzimm[9:4]',  'equivalent':'addi x2, x2'},
    ...
    'C.LWSP':   {'args':2,  'syntax':'r-i',     'i_width':9,    'format':'CI',  'opcode':2,     'funct3':2,                 'expansion_method':'times_4(x2)',		'expansion':'lw rd, offset[7:2](x2)',   'equivalent':'lw'},
    #'C.FLWSP':  {'args':2,  'syntax':'r-i',     'i_width':9,    'format':'CI',  'opcode':2,     'funct3':3,                 'expansion_method':'none',		     'expansion':'none'},
    'C.JR':     {'args':1,  'syntax':'r',                       'format':'CR',  'opcode':2,     'funct4':8,                 'expansion_method':'insert_x0+0',	'expansion':'jalr x0, rs1, 0',          'equivalent':'jalr'},
    ...
    'C.SWSP':   {'args':2,  'syntax':'r-i',     'i_width':8,    'format':'CI',  'opcode':2,     'funct3':6,                 'expansion_method':'times_4(x2)',		'expansion':'sw rs2, offset[8:2](x2)',  'equivalent':'sw'},

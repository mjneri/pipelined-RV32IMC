...
instruction_dict= {
    ...
    'C.ADDI4SPN':{'args':2, 'syntax':'r-i',     'i_width':10,   'format':'CIW', 'opcode':0,     'funct3':0,                 'comp_reg':True,    'expansion_method':'x2_times_4',    'expansion':'addi rd_, x2, nzimm[9:2]', 'equivalent':'addi'},
    'C.LW':     {'args':3,  'syntax':'r-i_r',   'i_width':7,    'format':'CLS', 'opcode':0,     'funct3':2,                 'comp_reg':True,    'expansion_method':'times_4',		'expansion':'lw rd_, offset(rs1_)',     'equivalent':'lw'},
    'C.SW':     {'args':3,  'syntax':'r-i_r',   'i_width':7,    'format':'CLS', 'opcode':0,     'funct3':6,                 'comp_reg':True,    'expansion_method':'times_4',		'expansion':'sw rs2_, offset(rs1_)',    'equivalent':'sw'},
    'C.NOP':    {'args':0,  'syntax':'none',                    'format':'N',   'opcode':1,                                 'comp_reg':False,   'expansion_method':'none',			'expansion':'none'},
    'C.ADDI':   {'args':2,  'syntax':'r-i',     'i_width':6,    'format':'CI',  'opcode':1,     'funct3':0,                 'comp_reg':False,   'expansion_method':'dup_reg',		'expansion':'addi rd, rd, imm'},
    'C.JAL':    {'args':1,  'syntax':'l',       'i_width':12,   'format':'CJ',  'opcode':1,     'funct3':1,                 'comp_reg':False,   'expansion_method':'insert_x1',		'expansion':'jal x1, label',            'equivalent':'jal'},
    'C.LI':     {'args':2,  'syntax':'r-i',     'i_width':6,    'format':'CI',  'opcode':1,     'funct3':2,                 'comp_reg':False,   'expansion_method':'insert_x0',		'expansion':'addi, rd, x0, imm',        'equivalent':'addi'},
    'C.ADDI16SP':{'args':1, 'syntax':'i',       'i_width':10,   'format':'C16', 'opcode':1,     'funct3':3,                 'comp_reg':False,   'expansion_method':'times_16',		'expansion':'addi x2, x2, nzimm[9:4]',  'equivalent':'addi x2, x2'},
    'C.LUI':    {'args':2,  'syntax':'r-i',     'i_width':18,   'format':'CI',  'opcode':1,     'funct3':3,                 'comp_reg':False,   'expansion_method':'none',			'expansion':'lui rd, nzimm[17:12]'},
    'C.SRLI':   {'args':2,  'syntax':'r-i',     'i_width':6,    'format':'CH',  'opcode':1,     'funct2':0, 'funct3':4,     'comp_reg':True,    'expansion_method':'dup_reg',		'expansion':'srli rd_, rd_, shamt'},
    'C.SRAI':   {'args':2,  'syntax':'r-i',	    'i_width':6,    'format':'CH',  'opcode':1,     'funct2':1, 'funct3':4,     'comp_reg':True,    'expansion_method':'dup_reg',		'expansion':'srai rd_, rd_, shamt'},
    'C.ANDI':   {'args':2,  'syntax':'r-i',	    'i_width':6,    'format':'CH',  'opcode':1,     'funct2':2, 'funct3':4,     'comp_reg':True,    'expansion_method':'dup_reg',		'expansion':'andi rd_, rd_, imm'},
    ...
    'C.J':      {'args':1,  'syntax':'l',       'i_width':12,   'format':'CJ',  'opcode':1,     'funct3':5,                 'comp_reg':False,   'expansion_method':'insert_x0',		'expansion':'jal, x0, label',           'equivalent':'jal'},
    'C.BEQZ':   {'args':2,  'syntax':'r-l',	    'i_width':9,    'format':'CB',  'opcode':1,     'funct3':6,                 'comp_reg':True,    'expansion_method':'insert_x0',		'expansion':'beq rs1_, x0, label',      'equivalent':'beq'},
    'C.BNEZ':   {'args':2,  'syntax':'r-l',	    'i_width':9,    'format':'CB',  'opcode':1,     'funct3':7,                 'comp_reg':True,    'expansion_method':'insert_x0',		'expansion':'bne rs1_, x0, label',      'equivalent':'bne'},
    'C.SLLI':   {'args':2,  'syntax':'r-i',	    'i_width':6,    'format':'CI',  'opcode':2,     'funct3':0,                 'comp_reg':False,   'expansion_method':'dup_reg',		'expansion':'slli rd, rd, shamt'},
    'C.LWSP':   {'args':2,  'syntax':'r-i',     'i_width':9,    'format':'CI',  'opcode':2,     'funct3':2,                 'comp_reg':False,   'expansion_method':'times_4(x2)',	'expansion':'lw rd, offset[7:2](x2)',   'equivalent':'lw'},
    ...
    'C.EBREAK': {'args':0,  'syntax':'none',                    'format':'N',   'opcode':36866,                             'comp_reg':False,   'expansion_method':'none',			'expansion':'ebreak'},
    ...
    'C.ADD':    {'args':2,  'syntax':'r-r',                     'format':'CR',  'opcode':2,     'funct4':9,                 'comp_reg':True,    'expansion_method':'dup_reg',		'expansion':'add rd_, rd_, rs2_'},
    'C.SWSP':   {'args':2,  'syntax':'r-i',     'i_width':8,    'format':'CI',  'opcode':2,     'funct3':6,                 'comp_reg':False,   'expansion_method':'times_4(x2)',	'expansion':'sw rs2, offset[8:2](x2)',  'equivalent':'sw'},

...
instruction_dict= {
    ...
    'BEQ':   {'syntax':'r-r-i', 'i_width':13,   'format':'B',   'opcode':99,    'funct3':0},
    'BNE':   {'syntax':'r-r-i', 'i_width':13,   'format':'B',   'opcode':99,    'funct3':1},
    'BLT':   {'syntax':'r-r-i', 'i_width':13,   'format':'B',   'opcode':99,    'funct3':4},
    'BGE':   {'syntax':'r-r-i', 'i_width':13,   'format':'B',   'opcode':99,    'funct3':5},
    'BLTU':  {'syntax':'r-r-i', 'i_width':13,   'format':'B',   'opcode':99,    'funct3':6},
    'BGEU':  {'syntax':'r-r-i', 'i_width':13,   'format':'B',   'opcode':99,    'funct3':7},
    ...
    'SLLI':  {'syntax':'r-r-i', 'i_width':5,    'format':'R',   'opcode':19,    'funct3':1, 'funct7':0},
    'SRLI':  {'syntax':'r-r-i', 'i_width':5,    'format':'R',   'opcode':19,    'funct3':5, 'funct7':0},
    'SRAI':  {'syntax':'r-r-i', 'i_width':5,    'format':'R',   'opcode':19,    'funct3':5, 'funct7':32},

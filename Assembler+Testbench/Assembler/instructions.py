...
instruction_dict= {
    ...
    'C.ADDI4SPN':{'args':2, 'syntax':'r-i',     'i_width':10,   'format':'CIW', 'opcode':0,     'funct3':0,                 'imm':'nzuimm',     'comp_reg':True,    'expansion_method':'x2_times_4',    'expansion':'addi rd_, x2, nzimm[9:2]', 'equivalent':'addi'},
    'C.LW':     {'args':3,  'syntax':'r-i_r',   'i_width':7,    'format':'CLS', 'opcode':0,     'funct3':2,                 'imm':'uimm',       'comp_reg':True,    'expansion_method':'times_4',		'expansion':'lw rd_, offset(rs1_)',     'equivalent':'lw'},
    'C.SW':     {'args':3,  'syntax':'r-i_r',   'i_width':7,    'format':'CLS', 'opcode':0,     'funct3':6,                 'imm':'uimm',       'comp_reg':True,    'expansion_method':'times_4',		'expansion':'sw rs2_, offset(rs1_)',    'equivalent':'sw'},
    ...
    'C.ADDI16SP':{'args':1, 'syntax':'i',       'i_width':10,   'format':'C16', 'opcode':1,     'funct3':3,                 'imm':'nzimm',                          'expansion_method':'times_16',		'expansion':'addi x2, x2, nzimm[9:4]',  'equivalent':'addi x2, x2'},
    'C.LUI':    {'args':2,  'syntax':'r-i',     'i_width':18,   'format':'CI',  'opcode':1,     'funct3':3,                 'imm':'nzimm',      'comp_reg':False,   'expansion_method':'none',			'expansion':'lui rd, nzimm[17:12]'},
    ...
    'C.J':      {'args':1,  'syntax':'l',       'i_width':12,   'format':'CJ',  'opcode':1,     'funct3':5,                                                         'expansion_method':'insert_x0',		'expansion':'jal, x0, label',           'equivalent':'jal'},
    ...
    'C.LWSP':   {'args':2,  'syntax':'r-i',     'i_width':9,    'format':'CI',  'opcode':2,     'funct3':2,                 'imm':'uimm',       'comp_reg':False,   'expansion_method':'times_4(x2)',	'expansion':'lw rd, offset[7:2](x2)',   'equivalent':'lw'},
